...
async function signup(){
    ...
    error.value = " Se ha enviado un correo de confirmación a tu cuenta de correo electrónico. Por favor, revisa tu bandeja de entrada."
...
<h1><RouterLink to="/login">🡠</RouterLink> Sign Up</h1>
        ...
        <input id="displayName" name="displayName" type="text" v-model="displayName" required>
        <br>    
        <label for="email">email</label>
        <input id="email" name="email" type="email" v-model="email" required>
        <br>    
        <label for="password">password</label>
        <input id="password" name="password" type="password" v-model="password" required @change="validate">
        <br>
        <label for="password">repeat password</label>
        <input id="passwordConfirm" name="passwordConfirm" type="passwordConfirm" v-model="passwordConfirm" required @keyup="validate">
        <br>
        ...
        <RouterLink to="/" tag="button" custom v-slot="{ navigate }">
